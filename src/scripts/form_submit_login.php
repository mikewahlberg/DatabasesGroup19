<?
  ...
  //Send data to DB
  mysql_query($link, "INSERT INTO APPLICANT(PID, stu_first_name, stu_last_name, stu_email, stu_phone, PHD_CS, semesters_grad,
  ...
  $url = "applicant popup window/" . PID;
  mail(adv_email, stu_first_name . " " . stu_last_name . " " . Information, $url, "From: " . stu_email);
?>
